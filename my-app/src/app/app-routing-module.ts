...
const routes: Routes = [
  ...
  { path: 'san-pham-2', component: Ex13, canActivate: [authGuard] },
  { path: 'san-pham-3', component: FakeProduct, canActivate: [authGuard] },
  { path: 'ex13', component: Ex13, canActivate: [authGuard] },
